...
declare class ScalisTriangle extends ScalisPrimitive {
     ...
     *
     */
    GenericSegmentComputation(point: THREE.Vector3, p1: THREE.Vector3, p1p2: THREE.Vector3, length: number, sqr_length: number, weight_1: number, delta_weight: number, res: Object): Object;
    /**
     *  value function for Distance volume type (distance field).
     *
     *  @param {THREE.Vector3} p
     ...
     */
    computeLineIntegral(t: number, p: THREE.Vector3, res: Object): Object;
    /**
     ...
     *  @protected
     */
    protected homotheticClippingSpecial(w: THREE.Vector3, length: number, clipped: Object): boolean;
    /**
     ...
     *  @protected
     */
    protected consWeightEvalForSeg(p_1: THREE.Vector3, w_1: number, unit_dir: THREE.Vector3, length: number, point: THREE.Vector3, res: any): Object;
    /**
     *  @param {!THREE.Vector3} p_1
     *  @param {number} w_1
     *  @param {!THREE.Vector3} unit_dir
     ...
     *  @protected
     */
    protected consWeightEvalGradForSeg(p_1: THREE.Vector3, w_1: number, unit_dir: THREE.Vector3, length: number, point: THREE.Vector3, res: any): Object;
    /**
     ...
     *  @return {boolean} true if clipping occured
     */
    ComputeTParam(point: THREE.Vector3, clipped: Object): boolean;
    /**
