...
declare class ScalisSegment extends ScalisPrimitive {
     ...
     */
    evalMat(p: THREE.Vector3, res: Object): void;
    /**
     ...
     */
    HomotheticCompactPolynomial_segment_F_i6(l: number, d: number, w: Object): number;
    /**
     *  Sub-function for optimized convolution value computation (Homothetic Compact Polynomial).
     ...
     *  @param {!Object} w
     */
    HomotheticCompactPolynomial_approx_segment_F_i6(l: number, d: number, q: number, w: Object): number;
    /**
     ...
     *
     */
    HomotheticCompactPolynomial_segment_FGradF_i6(l: number, d: number, w: Object): void;
    /**
     *  Sub-function for optimized convolution value and gradient computation (Homothetic Compact Polynomial).
     *  Function designed by Cedric Zanni, optimized for C++ using matlab.
     *  Result is stored in this.f0f1f2
     ...
     *  @param {!Object} w
     */
    HomotheticCompactPolynomial_approx_segment_FGradF_i6(l: number, d: number, q: any, w: Object): void;
}
