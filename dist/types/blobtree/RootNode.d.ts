...
declare class RootNode extends RicciNode {
     ...
     */
    isEmpty: () => boolean;
    intersectRayBlob: (this: import("./RootNode.js"), ray: THREE.Ray, res: IntersectionResult, maxDistance: number, _precision: number) => boolean;
    /**
     ...
     */
    intersectOrthoRayBlob: (this: import("./RootNode.js"), wOffset: number, hOffset: number, res: Array<IntersectionResult>, dim: Object) => void;
}
