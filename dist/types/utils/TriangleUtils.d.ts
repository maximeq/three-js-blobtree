 ...
 */
export function getParametrisedVertexAttr(triangle: Object, u: any, v: any): {
    pos: THREE.Vector3;
    thick: number;
};
/**
 ...
 *  @return {number}
 */
export function getMeanThick(triangle: Object, u: number, v: number): number;
/**
 *  @param {!Object} triangle The concerned triangle
 *  @param {number} u u coordinate
 *  @param {number} v v coordinate
 ...
 */
export function getMeanMat(triangle: Object, u: number, v: number): Material;
/**
