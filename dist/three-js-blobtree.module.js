...
var Types$o = /*@__PURE__*/getDefaultExportFromCjs(Types_1);

const THREE$r = require$$0;
...
var Element$4 = /*@__PURE__*/getDefaultExportFromCjs(Element_1);
 ...
 *  @extends {Element}
 */
let Node$7 = class Node extends Element$2 {
...
var Node$8 = /*@__PURE__*/getDefaultExportFromCjs(Node_1);
...
var Material$e = /*@__PURE__*/getDefaultExportFromCjs(Material_1);
 ...
 *  @extends Node
 */
let RicciNode$1 = class RicciNode extends Node$6 {
...
var RicciNode$2 = /*@__PURE__*/getDefaultExportFromCjs(RicciNode_1);
...
var RootNode$1 = /*@__PURE__*/getDefaultExportFromCjs(RootNode_1);
...
class DifferenceNode extends Node$5 {
    ...
    constructor(node0, node1, alpha){
        ...
        // Tmp vars to speed up computation (no reallocations)
        /** @type {{v:number, g:THREE.Vector3, m:Material}} */
        this.tmp_res0 = { v: 0, g: new THREE$m.Vector3(0, 0, 0), m: new Material$b() };

        /** @type {{v:number, g:THREE.Vector3, m:Material}} */
        this.tmp_res1 = { v: 0, g: new THREE$m.Vector3(0, 0, 0), m: new Material$b() };
...
var DifferenceNode$1 = /*@__PURE__*/getDefaultExportFromCjs(DifferenceNode_1);
...
var MinNode$1 = /*@__PURE__*/getDefaultExportFromCjs(MinNode_1);
...
class TwistNode extends Node$3 {
    ...
    */
    constructor(children) {
        ...
        this._twist_axis = new THREE$k.Vector3(0.0,1.0,0.0);
        this._twist_axis_mat = new THREE$k.Matrix4();
        this._twist_axis_mat_inv = new THREE$k.Matrix4();
     ...
     */
     static fromJSON(json) {
        ...
        res.setTwistAxis(new THREE$k.Vector3(json.axis_x
                                            ,json.axis_y
                                            ,json.axis_z));
        for (var i = 0; i < json.children.length; ++i) {
    ...
    _computeTransforms()
    {
        let r_angle = Math.acos(this._twist_axis.dot(new THREE$k.Vector3(0,1,0)));
...
var TwistNode$1 = /*@__PURE__*/getDefaultExportFromCjs(TwistNode_1);
...
class ScaleNode extends Node$2 {
    ...
    */
    constructor(children) {
        ...
        this.tmp_res = { v: 0, g: null, m: null };
        /** @type {THREE.Vector3} */
        this.tmp_g = new THREE$j.Vector3();
        /** @type {Material} */
        this.tmp_m = new Material$8();

        this._scale = new THREE$j.Vector3(1,1,1);
    ...
    prepareForEval () {
        if (!this.valid_aabb) {
            this.aabb = new THREE$j.Box3();  // Create empty BBox
            for (var i = 0; i < this.children.length; ++i) {
                var c = this.children[i];
                c.prepareForEval();
                this.aabb.union(c.getAABB());    // new aabb is computed according to remaining children aabb
            ...
            let bb_size = new THREE$j.Vector3();
            ...
            this.aabb.expandByVector(new THREE$j.Vector3(x_scale,y_scale,z_scale));
            this.valid_aabb = true;
        }
    };
    ...
    value (p, res) {
        ...
        if (this.aabb.containsPoint(p) && l !== 0) {
            ...
            let center = new THREE$j.Vector3();
            this.aabb.getCenter(center);

            let st_p =  new THREE$j.Vector3((p.x - center.x)/this._scale.x + center.x
...
var ScaleNode$1 = /*@__PURE__*/getDefaultExportFromCjs(ScaleNode_1);
 ...
 *  @extends {Element}
 */
let Primitive$2 = class Primitive extends Element$1 {
...
var Primitive$3 = /*@__PURE__*/getDefaultExportFromCjs(Primitive_1);
...
var ScalisMath$7 = /*@__PURE__*/getDefaultExportFromCjs(ScalisMath_1);
 ...
 *  @extends {Primitive}
 */
let ScalisPrimitive$3 = class ScalisPrimitive extends Primitive$1 {
...
var ScalisPrimitive$4 = /*@__PURE__*/getDefaultExportFromCjs(ScalisPrimitive_1);
 ...
 */
let ScalisVertex$3 = class ScalisVertex {

    static fromJSON(json) {
        return new ScalisVertex(new THREE$i.Vector3(json.position.x, json.position.y, json.position.z), json.thickness);
    }
    ...
    computeAABB() {
        ...
        this.aabb.set(new THREE$i.Vector3(
            pos.x - boundSupport,
            pos.y - boundSupport,
            pos.z - boundSupport
        ),
...
var ScalisVertex$4 = /*@__PURE__*/getDefaultExportFromCjs(ScalisVertex_1);
...
var Area$5 = /*@__PURE__*/getDefaultExportFromCjs(Area_1);
...
var Accuracies$5 = /*@__PURE__*/getDefaultExportFromCjs(Accuracies_1);
 ...
 *  @extends {Area}
 */
let AreaSphere$3 = class AreaSphere extends Area$3 {
    /**
    ...
    constructor(p, r, accFactor) {
        ...
        this.p = new THREE$h.Vector3(p.x, p.y, p.z);
        this.r = r;
...
var AreaSphere$4 = /*@__PURE__*/getDefaultExportFromCjs(AreaSphere_1);
...
class ScalisPoint extends ScalisPrimitive$2  {
    ...
    constructor(vertex, volType, density, mat) {
        ...
        this.v_to_p = new THREE$g.Vector3();
    }
...
var ScalisPoint$1 = /*@__PURE__*/getDefaultExportFromCjs(ScalisPoint_1);
 ...
 *
 */
let AreaScalisSeg$2 = class AreaScalisSeg extends Area$2 {
    ...
    constructor(p0, p1, thick0, thick1) {
        ...
        this.p0 = new THREE$f.Vector3(p0.x, p0.y, p0.z);
        this.p1 = new THREE$f.Vector3(p1.x, p1.y, p1.z);
        this.thick0 = thick0;
        this.thick1 = thick1;

        this.unit_dir = new THREE$f.Vector3().subVectors(p1, p0);
...
var AreaScalisSeg$3 = /*@__PURE__*/getDefaultExportFromCjs(AreaScalisSeg_1);
...
class ScalisSegment extends ScalisPrimitive$1 {
    ...
    constructor(v0, v1, volType, density, mats) {
        ...
        this.cycle = new THREE$e.Vector3();
        this.proj = new THREE$e.Vector3();
        // helper attributes
        this.v0_p = this.v[0].getPos();
        this.v1_p = this.v[1].getPos(); // this one is probably useless to be kept for eval since not used....
        this.dir = new THREE$e.Vector3();
        this.lengthSq = 0;
        this.length = 0;
        this.unit_dir = new THREE$e.Vector3();
        ...
        this.increase_unit_dir = new THREE$e.Vector3();
        this.p_min = new THREE$e.Vector3();
        this.weight_min = 0;
        ...
        this.cyl_bd0 = 0;
        this.cyl_bd1 = 0;
        this.f0f1f2 = new THREE$e.Vector3();

        this.tmpVec1 = new THREE$e.Vector3();
        this.tmpVec2 = new THREE$e.Vector3();
...
// [Abstract] see ScalisPrimitive.distanceTo
    distanceTo = (function() {
        var tmpVector = new THREE$e.Vector3();
        var tmpVectorProj = new THREE$e.Vector3();
        return function (p) {
            /** @type {ScalisSegment} */
            let self = this;
...
var ScalisSegment$1 = /*@__PURE__*/getDefaultExportFromCjs(ScalisSegment_1);
...
TriangleUtils$2.computeVectorsDirs = function(triangle){
    ...
    let dir_1 = new THREE$d.Vector3();
    dir_1 = dir_1.subVectors(point_1, triangle.point_min);
    let dir_2 = new THREE$d.Vector3();
    ...
    if(delta_1 < EPSILON || delta_2 < EPSILON)
    {
        ...
        { //delta_1 is closer to 0
            ...
            triangle.point_iso_zero = new THREE$d.Vector3( triangle.point_min.x + coord_iso_zero_dir*dir_2.x,
        ...
        { //delta_2 is closer to 0
            ...
            triangle.point_iso_zero = new THREE$d.Vector3(triangle.point_min.x + coord_iso_zero_dir*dir_1.x,
    ...
    { // WARNING : numerically instable if delta_ close to zero !
        ...
        let point_iso_zero1 = new THREE$d.Vector3(triangle.point_min.x + coord_iso_zero_dir1*dir_1.x,
        ...
        let point_iso_zero2 = new THREE$d.Vector3(triangle.point_min.x + coord_iso_zero_dir2*dir_2.x,
...
TriangleUtils$2.getTriBaryCoord = function(p0p1, p2p0, p0, p){
    ...
    let W = new THREE$d.Vector3().subVectors(p, p0);
...
TriangleUtils$2.getUVCoord = function(U, V, p0, p){
    let W = new THREE$d.Vector3();
    W.crossVectors(U,V);
    let mat = new THREE$d.Matrix4();
    mat.set(U.x, V.x, W.x,0,
            U.y, V.y, W.y,0,
            U.z, V.z, W.z,0,
              0,   0,   0,1);
    let mat1 = new THREE$d.Matrix4();
    mat1.copy(mat).invert();
    let vec = new THREE$d.Vector3().subVectors(p, p0);
 ...
 *  @extends {Area}
 */
let AreaScalisTri$1 = class AreaScalisTri extends Area$1 {
    /**
    ...
    constructor(v, unit_normal, main_dir, segParams, min_thick, max_thick) {
        ...
        this.tmpVect = new THREE$c.Vector3();
     ...
     */
    contains = (function () {
        let sphere = { radius: 0, center: new THREE$c.Vector3() };
        /**
         * @param {THREE.Vector3} p
         */
        return (p) => {
...
var AreaScalisTri$2 = /*@__PURE__*/getDefaultExportFromCjs(AreaScalisTri_1);
...
class ScalisTriangle extends ScalisPrimitive {
    ...
    this.p0p1  = new THREE$b.Vector3();
    this.p1p2 = new THREE$b.Vector3();
    this.p2p0 = new THREE$b.Vector3();
    this.unit_normal = new THREE$b.Vector3();
    this.unit_p0p1 = new THREE$b.Vector3();
    this.unit_p1p2 = new THREE$b.Vector3();
    this.unit_p2p0 = new THREE$b.Vector3();
    this.length_p0p1 = 0;
    this.length_p1p2 = 0;
    this.length_p2p0 = 0;
    this.diffThick_p0p1 = 0;
    ...
    this.main_dir       = new THREE$b.Vector3();
    this.point_iso_zero = new THREE$b.Vector3();
    this.ortho_dir      = new THREE$b.Vector3();
    this.unsigned_ortho_dir= new THREE$b.Vector3();
    this.proj_dir       = new THREE$b.Vector3();
    this.equal_weights = false; // Use to skip computations for a specific case

    this.coord_max           = 0;
    this.coord_middle        = 0;
    this.unit_delta_weight   = 0;
    this.longest_dir_special = new THREE$b.Vector3();
    this.max_seg_length      = 0;
    this.half_dir_1 = new THREE$b.Vector3();
    this.point_half = new THREE$b.Vector3();
    this.half_dir_2 = new THREE$b.Vector3();
    this.point_min = new THREE$b.Vector3();
    this.weight_min = 0;
    ...
    distanceTo = (function() {
        var p0p = new THREE$b.Vector3();
        var p1p = new THREE$b.Vector3();
        var p2p = new THREE$b.Vector3();
        var tmp = new THREE$b.Vector3();
        return function (p) {
    ...
    evalDist = (function() {
        ...
        return function (p, res) {
            ...
            */
            ...
            var p0_to_p = new THREE$b.Vector3();
            ...
            if(!self.equal_weights){
                ...
                var d1n2n3 = new THREE$b.Vector3();
                d1n2n3.crossVectors(n2,n3);
                d1n2n3.multiplyScalar(-d1);
                var d2n3n1 = new THREE$b.Vector3();
                d2n3n1.crossVectors(n3,n1);
                d2n3n1.multiplyScalar(-d2);
                var d3n1n2 = new THREE$b.Vector3();
                d3n1n2.crossVectors(n1,n2);
                d3n1n2.multiplyScalar(-d3);
                var n2cn3 = new THREE$b.Vector3();
                n2cn3.crossVectors(n2,n3);
                var Z = new THREE$b.Vector3(  d1n2n3.x+d2n3n1.x+d3n1n2.x,
                ...
                var pz = new THREE$b.Vector3(Z.x-p.x,Z.y-p.y,Z.z-p.z);

                // set proj_dir
                self.proj_dir = new THREE$b.Vector3();
            ...
            var non_ortho_proj = new THREE$b.Vector3();
            ...
            var tmp_vec = new THREE$b.Vector3();
            var tmp_vec0 = new THREE$b.Vector3();
            var tmp_vec1 = new THREE$b.Vector3();
            var tmp_vec2 = new THREE$b.Vector3();
    ...
    */
    ...
    GenericSegmentComputation(  point,
                                ...
                                res)
    {
        var origin_to_p = new THREE$b.Vector3();
        ...
        res.proj_to_p = new THREE$b.Vector3(  t*p1p2.x - origin_to_p.x,
    ...
    evalConvol = (function() {
        ...
        var g = new THREE$b.Vector3();
        var m = new Material$4();
        var tmpRes = {v:0,g:null,m:null};
        var g2 = new THREE$b.Vector3();
        ...
        return function (p, res) {
            ...
            if (self.ComputeTParam(p, clipped)) {
                ...
                d_step_size *= 2.0;
                var res_odd = 0.0;
                var grad_odd = new THREE$b.Vector3();
                ...
                var res_even = 0.0;
                var grad_even = new THREE$b.Vector3();
                t = 0.0;
                ...
                res.v *= factor;
                if (res.g) {
                    var grad_res = new THREE$b.Vector3();
   ...
   warpAbscissa(t) {
    ...
    consWeightEvalForSeg( p_1, w_1, unit_dir, length, point, res) {
        var p_min_to_point = new THREE$b.Vector3();
        p_min_to_point.subVectors( point, p_1 );
        var uv = unit_dir.dot(p_min_to_point);
        var d2 = p_min_to_point.lengthSq();

        var special_coeff = new THREE$b.Vector3();
    ...
    consWeightEvalGradForSeg( p_1, w_1, unit_dir, length, point, res) {
        ...
        if(this.homotheticClippingSpecial(special_coeff, length, clipped))
        {
            ...
            var F0F1F2 = new THREE$b.Vector3();
...
var ScalisTriangle$1 = /*@__PURE__*/getDefaultExportFromCjs(ScalisTriangle_1);
 ...
 *  @constructor
 */
let DistanceFunctor$2 = class DistanceFunctor {
...
var DistanceFunctor$3 = /*@__PURE__*/getDefaultExportFromCjs(DistanceFunctor_1);
...
var Poly6DistanceFunctor$1 = /*@__PURE__*/getDefaultExportFromCjs(Poly6DistanceFunctor_1);
 ...
 *  @extends {Node}
 */
let SDFNode$1 = class SDFNode extends Node$1
{
 ...
 *  @extends {Element}
 */
let SDFPrimitive$5 = class SDFPrimitive extends Element {
    ...
    constructor() {
        ...
        // Default bounding box for a SDF is infinite.
        this.aabb.set(
            new THREE$9.Vector3(- Infinity, - Infinity, - Infinity),
            new THREE$9.Vector3(+ Infinity, + Infinity, + Infinity)
        );
    }
    ...
    computeDistanceAABB(_d) {
        ...
        return (new THREE$9.Box3()).makeEmpty()
    }
...
var SDFPrimitive$6 = /*@__PURE__*/getDefaultExportFromCjs(SDFPrimitive_1);
...
class SDFRootNode extends Primitive {
    ...
    constructor(f, material, sdfRoot)
    {
        ...
        this.tmp_g = new THREE$8.Vector3(0,0,0);
    }
    ...
    {
        if(!this.valid_aabb){
            this.aabb = new THREE$8.Box3();  // Create empty BBox
...
var SDFRootNode$1 = /*@__PURE__*/getDefaultExportFromCjs(SDFRootNode_1);
...
class SDFPoint extends SDFPrimitive$3 {
     ...
     */
    static fromJSON(json) {
        return new SDFPoint(new THREE$7.Vector3(json.p.x, json.p.y, json.p.z), json.acc);
    };
    ...
    computeDistanceAABB(d) {
        return new THREE$7.Box3(
            this.p.clone().add(new THREE$7.Vector3(-d,-d,-d)),
            this.p.clone().add(new THREE$7.Vector3(d,d,d))
        );
    };
    // [Abstract]
...
var SDFPoint$1 = /*@__PURE__*/getDefaultExportFromCjs(SDFPoint_1);
 ...
 * @constructor
 */
let AreaCapsule$2 = class AreaCapsule extends Area {
    ...
    constructor(p1, p2, r1, r2, accFactor1, accFactor2) {
        ...
        this.unit_dir = new THREE$6.Vector3().subVectors(p2, p1);
        this.length = this.unit_dir.length();
        this.unit_dir.normalize();

        // tmp var for functions below
        this.vector = new THREE$6.Vector3();
...
var AreaCapsule$3 = /*@__PURE__*/getDefaultExportFromCjs(AreaCapsule_1);
...
class SDFSegment extends SDFPrimitive$2  {
    ...
    static fromJSON(json) {
        return new SDFSegment(
            new THREE$5.Vector3(json.p1.x, json.p1.y, json.p1.z),
            new THREE$5.Vector3(json.p2.x, json.p2.y, json.p2.z),
            json.acc
        );
    };
    ...
    constructor(p1, p2, acc)
    {
        ...
        /** @type {THREE.Line3} */
        this.l = new THREE$5.Line3(this.p1, this.p2);
    }
    ...
    // [Abstract]
    computeDistanceAABB(d) {
        var b1 = new THREE$5.Box3(
            this.p1.clone().add(new THREE$5.Vector3(-d,-d,-d)),
            this.p1.clone().add(new THREE$5.Vector3(d,d,d))
        );
        var b2 = new THREE$5.Box3(
            this.p2.clone().add(new THREE$5.Vector3(-d,-d,-d)),
            this.p2.clone().add(new THREE$5.Vector3(d,d,d))
        );
        return b1.union(b2);
    };
...
var SDFSegment$1 = /*@__PURE__*/getDefaultExportFromCjs(SDFSegment_1);
...
class SDFSphere extends SDFPrimitive$1 {
     ...
     */
    static fromJSON(json) {
        return new SDFSphere(new THREE$4.Vector3(json.p.x, json.p.y, json.p.z), json.r);
    };
    ...
    // [Abstract]
    computeDistanceAABB(d) {
        return new THREE$4.Box3(
            this.p.clone().add(new THREE$4.Vector3(-this.r-d,-this.r-d,-this.r-d)),
            this.p.clone().add(new THREE$4.Vector3(this.r+d,this.r+d,this.r+d))
        );
    };
...
var SDFSphere$1 = /*@__PURE__*/getDefaultExportFromCjs(SDFSphere_1);
...
class SDFCapsule extends SDFPrimitive {
    ...
    static fromJSON(json) {
        ...
        return new SDFCapsule(
            new THREE$3.Vector3(json.p1.x, json.p1.y, json.p1.z),
            new THREE$3.Vector3(json.p2.x, json.p2.y, json.p2.z),
            json.r1,
            json.r2
        );
    }
    ...
    constructor(p1, p2, r1, r2) {
        ...
        this.unit_dir = new THREE$3.Vector3().subVectors(this.p2, this.p1);
    ...
    computeDistanceAABB(d) {
        var b1 = new THREE$3.Box3(
            this.p1.clone().add(new THREE$3.Vector3(-this.r1 - d, -this.r1 - d, -this.r1 - d)),
            this.p1.clone().add(new THREE$3.Vector3(this.r1 + d, this.r1 + d, this.r1 + d))
        );
        var b2 = new THREE$3.Box3(
            this.p2.clone().add(new THREE$3.Vector3(-this.r2 - d, -this.r2 - d, -this.r2 - d)),
            this.p2.clone().add(new THREE$3.Vector3(this.r2 + d, this.r2 + d, this.r2 + d))
        );
        return b1.union(b2);
    };
     ...
     */
    value = (function () {
        var v = new THREE$3.Vector3();
        var proj = new THREE$3.Vector3();
        /**
         *  @param {THREE.Vector3} p
         *  @param {ValueResultType} res
         */
        return function (p, res) {
            ...
            var a = THREE$3.MathUtils.clamp(proj_x / self.length, 0, 1.0);
...
var SDFCapsule$1 = /*@__PURE__*/getDefaultExportFromCjs(SDFCapsule_1);
...
let SlidingMarchingCubes$1 = class SlidingMarchingCubes {
    /**
    ...
    constructor(blobtree, smcParams) {
        ...
        /** @type {THREE.Vector3} */
        this.vertex = new THREE$2.Vector3(0, 0, 0); // vertex associated to the cell if any
        /** @type {THREE.Vector3} */
        this.vertex_n = new THREE$2.Vector3(0, 0, 0); // vertex normal
        /** @type {Material} */
        ...
        this.extended = false;
        /** @type {THREE.Box3} */
        this.dis_o_aabb = new THREE$2.Box3();
        /** @type {THREE.Vector3} */
        this.ext_p = new THREE$2.Vector3();
        ...
        (function ()
        {
            ...
            /** @type {THREE.Vector3} */
            let p1 = new THREE$2.Vector3(); //v1 position
            /** @type {THREE.Vector3} */
            let p2 = new THREE$2.Vector3(); //v2 position
            /** @type {THREE.Vector3} */
            let p3 = new THREE$2.Vector3(); //v3 position
            /** @type {THREE.Vector3} */
            let p4 = new THREE$2.Vector3(); //v4 position
            //Edges from v2
            /** @type {THREE.Vector3} */
            let pp_2_1 = new THREE$2.Vector3(); //v2v1 edge
            /** @type {THREE.Vector3} */
            let pp_2_3 = new THREE$2.Vector3(); //v2v3 edge
            /** @type {THREE.Vector3} */
            let pp_2_4 = new THREE$2.Vector3(); //v2v4 edge
            //Edges from v4
            /** @type {THREE.Vector3} */
            let pp_4_1 = new THREE$2.Vector3(); //v4v1 edge
            /** @type {THREE.Vector3} */
            let pp_4_3 = new THREE$2.Vector3(); //v3v1 edge
            /** @type {THREE.Vector3} */
            let n_2 = new THREE$2.Vector3(); //123 normal
            /** @type {THREE.Vector3} */
            let n_4 = new THREE$2.Vector3(); //341 normal
            /** @type {THREE.Vector3} */
            let n_23 = new THREE$2.Vector3(); //234 normal
            /** @type {THREE.Vector3} */
            let n_42 = new THREE$2.Vector3(); //412 normal
    ...
    buildResultingBufferGeometry () {
        var res = new THREE$2.BufferGeometry();
        res.setAttribute(
            "position",
            new THREE$2.BufferAttribute(new Float32Array(this.geometry.position), 3)
        );
        res.setAttribute(
            "normal",
            new THREE$2.BufferAttribute(new Float32Array(this.geometry.normal), 3)
        );
        res.setAttribute(
            "color",
            new THREE$2.BufferAttribute(new Float32Array(this.geometry.color), 3)
        );
        res.setAttribute(
            "roughness",
            new THREE$2.BufferAttribute(new Float32Array(this.geometry.roughness), 1)
        );
        res.setAttribute(
            "metalness",
            new THREE$2.BufferAttribute(new Float32Array(this.geometry.metalness), 1)
        );

        res.setIndex(
            new THREE$2.BufferAttribute(
    ...
    recursiveBoxComputation(
        ...
        if (diff.x > 1 && diff.x >= diff.y) {
            ...
            new_boxes = [
                new Box2Acc(
                    box.min,
                    new THREE$2.Vector2(x_cut, box.max.y),
                    10000,
                    10000
                ),
                new Box2Acc(
                    new THREE$2.Vector2(x_cut, box.min.y),
                    box.max,
                    10000,
                    10000
                )
            ...
            if (diff.y > 1) {
                ...
                new_boxes = [
                    new Box2Acc(
                        box.min,
                        new THREE$2.Vector2(box.max.x, y_cut),
                        10000,
                        10000
                    ),
                    new Box2Acc(
                        new THREE$2.Vector2(box.min.x, y_cut),
                        box.max,
                        10000,
                        10000
                    )
        ...
        */
        ...
        for (let k = 0; k < new_boxes.length; ++k) {
            ...
            let bsize = b.getSize(new THREE$2.Vector2());
    ...
    computeFrontValues(cx, cy, cz) {
        ...
        for (var i = 0; i < areas.length; ++i) {
            ...
            boxes2D.push(
                new Box2Acc(
                    new THREE$2.Vector2(x_min, y_min),
                    new THREE$2.Vector2(x_max, y_max),
                    nice_acc,
                    raw_acc
                )
            );
        ...
        bigbox.intersect(
            new Box2Acc(
                new THREE$2.Vector2(0, 0),
                new THREE$2.Vector2(this.reso[0], this.reso[1]),
                bigbox.getNiceAcc(),
                bigbox.getRawAcc()
            )
        );
    ...
    compute(o_aabb, extended) {
        ...
        if (this.extended) {
            let adims = aabb.getSize(new THREE$2.Vector3());
            let minAcc = Math.min(
        ...
        var corner = aabb.min;
        var dims = aabb.getSize(new THREE$2.Vector3());
        ...
        var trim_aabb = new THREE$2.Box3();
        ...
        for (var iz = 0; iz < this.reso[2] - 1; ++iz) {
            ...
            trim_aabb.set(
                new THREE$2.Vector3(corner.x, corner.y, z1 - this.min_acc / 64),
                new THREE$2.Vector3(
...
var SlidingMarchingCubes$2 = /*@__PURE__*/getDefaultExportFromCjs(SlidingMarchingCubes_1);
...
class MaxNode extends Node {
    ...
    constructor(children) {
        ...
        this.tmp_res = { v: 0, g: null, m: null };
        /** @type {THREE.Vector3} */
        this.tmp_g = new THREE$1.Vector3();
        /** @type {Material} */
    ...
    prepareForEval () {
        if (!this.valid_aabb) {
            this.aabb = new THREE$1.Box3();  // Create empty BBox
            for (var i = 0; i < this.children.length; ++i) {
                var c = this.children[i];
                c.prepareForEval();
                this.aabb.union(c.getAABB());     // new aabb is computed according to remaining children aabb
...
var MaxNode$1 = /*@__PURE__*/getDefaultExportFromCjs(MaxNode_1);
...
class SplitMaxPolygonizer {
    ...
    setBlobtree(blobtree) {
        ...
        var addToSubtrees = function (n) {
            var subtree = null;
            if (n instanceof RootNode$1) {
                subtree = n.clone();
            }
            else {
                subtree = new RootNode$1();
                subtree.addChild(n.clone());
            }
            self.subtrees.push(subtree);
            subtree.prepareForEval();
            self.minAccs.push(getBlobtreeMinAcc(subtree));
            self.progCoeff.push(subtree.count(ScalisPoint$1) + subtree.count(ScalisSegment$1) + subtree.count(ScalisTriangle$1));
            self.totalCoeff += self.progCoeff[self.progCoeff.length - 1];
        };
        var recurse = function (n) {
            if (n instanceof RicciNode$2) {
            ...
            else if (n instanceof MaxNode$1) {
                for (let i = 0; i < n.children.length; ++i) {
                    recurse(n.children[i]);
                }
            }
            else if (n instanceof ScalisPoint$1) {
                addToSubtrees(n);
            }
            else if (n instanceof ScalisSegment$1) {
                addToSubtrees(n);
            }
            else if (n instanceof ScalisTriangle$1) {
                addToSubtrees(n);
            }
            else {
                addToSubtrees(n);
    ...
    compute() {
        ...
        for (var i = 0; i < this.subtrees.length; ++i) {
            ...
            switch (this.subPolygonizer.className) {
                case "SlidingMarchingCubes":
                    polygonizer = new SlidingMarchingCubes$2(this.subtrees[i], this.subPolygonizer.smcParams);
            }
...
var SplitSMC$1 = /*@__PURE__*/getDefaultExportFromCjs(SplitSMC_1);

const version = "1.0.0";

export { Accuracies$5 as Accuracies, Area$5 as Area, AreaCapsule$3 as AreaCapsule, AreaScalisSeg$3 as AreaScalisSeg, AreaScalisTri$2 as AreaScalisTri, AreaSphere$4 as AreaSphere, DifferenceNode$1 as DifferenceNode, DistanceFunctor$3 as DistanceFunctor, Element$4 as Element, Material$e as Material, MinNode$1 as MaxNode, MinNode$1 as MinNode, Node$8 as Node, Poly6DistanceFunctor$1 as Poly6DistanceFunctor, Primitive$3 as Primitive, RicciNode$2 as RicciNode, RootNode$1 as RootNode, SDFCapsule$1 as SDFCapsule, SDFPoint$1 as SDFPoint, SDFPrimitive$6 as SDFPrimitive, SDFRootNode$1 as SDFRootNode, SDFSegment$1 as SDFSegment, SDFSphere$1 as SDFSphere, ScaleNode$1 as ScaleNode, ScalisMath$7 as ScalisMath, ScalisPoint$1 as ScalisPoint, ScalisPrimitive$4 as ScalisPrimitive, ScalisSegment$1 as ScalisSegment, ScalisTriangle$1 as ScalisTriangle, ScalisVertex$4 as ScalisVertex, SlidingMarchingCubes$2 as SlidingMarchingCubes, SplitMaxPolygonizer, SplitSMC$1 as SplitSMC, TwistNode$1 as TwistNode, Types$o as Types, version };
