...
class SlidingMarchingCubes {
    ...
    constructor(blobtree, smcParams) {
        ...
        //Edges from v2
        var pp_2_1 = new THREE.Vector3();                
        var pp_2_3 = new THREE.Vector3();                        
        var pp_2_4 = new THREE.Vector3();
        //Edges from v4
        var pp_4_1 = new THREE.Vector3();
        var pp_4_3 = new THREE.Vector3();
        var n_2 = new THREE.Vector3();
        var n_4 = new THREE.Vector3();
        var n_23 = new THREE.Vector3();
        var n_42 = new THREE.Vector3();
