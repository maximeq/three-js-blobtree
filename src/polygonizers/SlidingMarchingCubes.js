...
class SlidingMarchingCubes {
    ...
    constructor(blobtree, smcParams) {
        ...
        /** @type {THREE.Vector3} */
        var p1 = new THREE.Vector3(); //v1 position
        /** @type {THREE.Vector3} */
        var p2 = new THREE.Vector3(); //v2 position
        /** @type {THREE.Vector3} */
        var p3 = new THREE.Vector3(); //v3 position
        /** @type {THREE.Vector3} */
        var p4 = new THREE.Vector3(); //v4 position
        //Edges from v2
        /** @type {THREE.Vector3} */
        var pp_2_1 = new THREE.Vector3(); //v2v1 edge
        /** @type {THREE.Vector3} */                
        var pp_2_3 = new THREE.Vector3(); //v2v3 edge
        /** @type {THREE.Vector3} */                        
        var pp_2_4 = new THREE.Vector3(); //v2v4 edge
        //Edges from v4
        /** @type {THREE.Vector3} */
        var pp_4_1 = new THREE.Vector3(); //v4v1 edge
        /** @type {THREE.Vector3} */
        var pp_4_3 = new THREE.Vector3(); //v3v1 edge
        /** @type {THREE.Vector3} */
        var n_2 = new THREE.Vector3(); //123 normal
        /** @type {THREE.Vector3} */
        var n_4 = new THREE.Vector3(); //341 normal
        /** @type {THREE.Vector3} */
        var n_23 = new THREE.Vector3(); //234 normal
        /** @type {THREE.Vector3} */
        var n_42 = new THREE.Vector3(); //412 normal
